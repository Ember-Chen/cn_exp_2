...
//        }
        ...
        broadcast(userList(),"update_user");
    }
    ...
    public void onMessage(String message, Session session, @PathParam("username") String username){
        ...
        } else if(msgType.equals("side_txt")){ // 转发
            sendOneMsg(username,target,content,msgType);
        } else if(msgType.equals("group_txt")){ // 转发
        ...
        } else if(msgType.equals("update_user")){
            sendOneMsg("SERVER",username,userList(),"update_user");
        }
        else {
...
//        if(username.equals("ADMIN")) return;
    ...
    public static void exile(String username){
        ...
        if(s==null) {
            sendOneMsg("SERVER","ADMIN","用户不存在","console");
            return;
        }
